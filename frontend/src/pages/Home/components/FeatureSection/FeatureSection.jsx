...
const features = [
  ...
  },
  {
    ...
    description:
      'Tìm kiếm thú cưng không chỉ là việc phát hiện những bé vật nuôi bị thất lạc, mà còn là cơ hội nhận nuôi một người bạn bốn chân tuyệt vời và tìm kiếm ngôi nhà mới đầy yêu thương cho những thú cưng cần sự chăm sóc. Chúng tôi hỗ trợ bạn kết nối và mang niềm vui, hạnh phúc đến cho mọi gia đình.',
    link: '/rescue',
              ...
              return (
                ...
                >
                  <CardBody textAlign="center" p={6}>
                    ...
                    >
                      <Box as={Icon} boxSize={6} color={feature.color} />
                    </Box>
