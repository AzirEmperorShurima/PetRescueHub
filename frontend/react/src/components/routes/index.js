...
import PetGuide from '../../pages/PetGuide/PetGuide.jsx';
// Admin
...
const AppRoutes = () => [
  ...
  <Route key="main" path="/" element={<MainLayout />}>
    ...
    {/* Giữ route PetGuide ở đây nếu muốn công khai */}
    {/* Make sure this path is lowercase to match Navigation.jsx */}
    ...
    <Route element={<ProtectedRoute />}>
      ...
      {/* Xóa route PetGuide ở đây để tránh trùng lặp */}
      {/* <Route path="petguide/" element={<PetGuide />} /> */}
