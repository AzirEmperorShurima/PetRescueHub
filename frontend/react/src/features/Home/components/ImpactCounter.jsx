  ...
  return (
    <section className="impact-counter-section" id="impact-counter">
      <Container maxWidth="lg">
        ...
        <Grid container spacing={4} className="impact-counter-container" ref={ref}>
          {counterData.map((stat) => (
            <Grid item xs={12} sm={6} md={3} key={stat.id}>
              <Card className="impact-counter-card">
                <Box className="counter-icon-container" sx={{ backgroundColor: `${stat.color}20` }}>
                  <Box className="counter-icon" sx={{ color: stat.color }}>
                    {stat.icon === 'pets' && (
                ...
                <Typography 
                  variant="h3" 
                  className="counter-value counter-animated"
                  sx={{ color: stat.color }}
                >
                  {stat.value}+
                </Typography>
