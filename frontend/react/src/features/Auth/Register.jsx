    ...
    return (
        <div className="login-form-container">
                    ...
                    <div className="form-options">
                        <div className="terms-agreement">
                            <input 
                                ...
                                required
                            />
                            <label htmlFor="terms">Tôi đồng ý với <Link to="/terms">Điều khoản sử dụng & Chính sách riêng tư</Link></label>
                        </div>
                    </div>
            ...
            <div className="auth-image-container">
                <img src="https://images.unsplash.com/photo-1592664858934-40ca080ab56b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="animal protection" className="auth-image" />
                <div className="auth-quote">
                <p>Mỗi ngày, hàng nghìn thú cưng như chú chó này đang cần sự giúp đỡ. Đăng ký để cùng chúng tôi mang lại huy vọng cho cho những sinh mạng nhỏ bé.</p>
